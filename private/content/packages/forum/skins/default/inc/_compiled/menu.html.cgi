# Generated: Fri Mar 15 19:48:54 2019
#
...
push @p,'<nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" style="font-size: 20px;font-weight: bold;" href="/">';push @p,$system->pkg('system')->_config->get('siteName');push @p,'</a>
          </div>
          <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
              <li';if(($v->{'page'} eq 'index')){push @p,' class="active"';}push @p,'><a href="/">Главная</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="" data-toggle="modal" data-target="#regModal">Регистрация</a></li>
                <li><a href="#" data-toggle="modal" data-target="#loginModal"><span class="glyphicon glyphicon-user"></span>&nbsp;Войти</a></li>
              ';}push @p,'
              ';if((true($v->{'login'}))){push @p,'
                <li class="dropdown">
                    <a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        <span class="glyphicon glyphicon-user"></span>&nbsp;';push @p,$v->{'fuser'}->{'uvorname'};push @p,' ';push @p,$v->{'fuser'}->{'uname'};push @p,'
                    </a>
                    <ul class="dropdown-menu">
                        <li><a href=""><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Мой профиль</a></li>
                        <li><a href="" id="logoutButton"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> Выход</a></li>
                    </ul>
                  </li>
                ';}push @p,'
            </ul>
